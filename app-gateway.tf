...
resource "azurerm_application_gateway" "network" {
  ...
  resource_group_name = azurerm_resource_group.aks_node_rg.name
  ...
  depends_on = [azurerm_virtual_network.aksvnet, azurerm_public_ip.public_ip,azurerm_resource_group.aks_node_rg]
}